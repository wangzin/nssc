        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <table id="sliderDetails" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach($linkList as $i=> $link): if($link['Link_Type']=="othersitelink"){ ?>
                      <tr>
                        <td> <?php echo $link['Link_Name'];?> </td>
                        <td> <?php echo $link['Link_Address'];?> </td>
                        <td> <?php echo $link['Posted_Date'];?> </td>
                        <td>
                           <button type="button" class="btn btn-info btn-block" onclick="editdetials('<?php echo $link['Id']?>','<?php echo $link['Link_Name']?>','<?php echo $link['Link_Address']?>','<?php echo $link['Link_Type']?>')"><i class="fa fa-edit"></i>Edit</button>
...
<script type="text/javascript">
  ...
  function addlinkDetails(){
      if(validateaddform()){
        ...
        var url='<?php echo base_url();?>index.php?adminController/loadPage/othersitelink/addlink';
    ...
    function deleteslider(){
      $.blockUI
          ...
          var url='<?php echo base_url();?>index.php?adminController/loadPage/othersitelink/deletelink/'+$('#deleteId').val();
